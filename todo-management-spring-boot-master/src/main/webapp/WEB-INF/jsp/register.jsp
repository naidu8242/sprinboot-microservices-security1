          ...
          <div class="card-body p-md-6">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form class="mx-1 mx-md-4 was-validated" id="register" action="register" method="post">
                  ...
                  <a href="/"><i class="fa fa-chevron-circle-left" style="font-size:36px;color:#0d6efd" ></i></a>&nbsp;&nbsp;&nbsp;
